...
class Product(Base):
    ...
    ACV: Mapped[float | None] = mapped_column(Numeric, nullable=True)
    z_level: Mapped[float | None] = mapped_column(Numeric, nullable=True)
    lead_time_days: Mapped[int | None] = mapped_column(Integer, nullable=True)
    SS: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ROP: Mapped[int | None] = mapped_column(Integer, nullable=True)
    EOQ: Mapped[int | None] = mapped_column(Integer, nullable=True)
    SMIN: Mapped[int | None] = mapped_column(Integer, nullable=True)
    SMAX: Mapped[int | None] = mapped_column(Integer, nullable=True)
    OnHand: Mapped[int | None] = mapped_column(Integer, nullable=True)
    BelowROP: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
